...
$workers = [
    ...
    ['id'=>9,'name'=>'Єлизавета','position'=>'Адміністратор','imageName'=>'worker10','details'=>'Організовує запис клієнтів. Досвід роботи: 3 роки.'],
    ['id'=>10,'name'=>'Валерія','position'=>'Менеджер','imageName'=>'worker11','details'=>'Відповідає за керування персоналом.'],
    ['id'=>11,'name'=>'Таїсія','position'=>'Юрист','imageName'=>'worker12','details'=>'Юридичний супровід бізнесу.'],
    ['id'=>12,'name'=>'В\'ячеслав','position'=>'Охоронець','imageName'=>'worker13','details'=>'Забезпечує безпеку клієнтів та персоналу.'],
    ['id'=>13,'name'=>'Назар','position'=>'Охоронець','imageName'=>'worker14','details'=>'Забезпечує охорону майна та безпеку персоналу.'],
    ['id'=>14,'name'=>'Дарія','position'=>'Прибиральниця','imageName'=>'worker15','details'=>'Забезпечує чистоту салону.'],
];
?>
